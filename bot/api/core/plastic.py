...
def pred_plastic():
    ...
    os.system(f'{PH}darknet.exe detector test {PH}cfg/2coco.data {PH}cfg/custom-yolov4-detector_plastic.cfg {PH}71_plastic_custom-yolov4-detector_best.weights C:/Final_Bot/data/prediction.jpg -thresh 0.6 -dont-show -ext_output < {PH}data/train_plastic.txt > {PH}result_plastic.txt')
